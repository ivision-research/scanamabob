...
parser.add_argument(
    "-l", "--list-scans", action="store_true", help="List the scans available to run"
)
parser.add_argument(
    "-P",
    "--permissions",
...
parser.add_argument(
    "scantypes", nargs="*", help="Specific scan suites or individual scans to run"
)
...
def get_permissions(scantypes):
    ...
    policy = {
        "Version": "2012-10-17",
        "Statement": [
            {"Effect": "Allow", "Action": sorted(permissions), "Resource": "*"}
        ],
    }
